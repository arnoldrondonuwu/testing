    ...
    return (<WebView
      ...
      return (
        ...
        <View style={{ flex: 1, paddingHorizontal: 8, marginTop: 16, backgroundColor: '#F4F4F4' }}>
          ...
          <View style={{ flex: 1, marginTop: 1, alignItems: 'center' }}>
            <TextInput
            placeholder="Nominal Top Up"
            style={{borderWidth: 1, borderColor: "#8c8c8c", marginBottom: 8,   backgroundColor: '#FFFFFF', borderRadius: 11, width:300, height: 40  }}
