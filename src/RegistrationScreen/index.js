...
import { View, TextInput, Button, Alert, Image, ScrollView } from 'react-native';
...
export default function RegistrationScreen({ navigation }) {
    ...
    const _submitRegistrasi = () =>{
      console.log(`Nama: ${nama} Email: ${email}  Nomorhandphone: ${nomorHandphone} Password: ${password}`);
    ...
    return (
      <ScrollView>
      <View style={{ flex: 1, paddingHorizontal: 8, marginTop: 16, alignItems: 'center',  justifyContent: 'center'}}>
        <TextInput
        placeholder="Email"
        style={{ borderWidth: 1, borderColor: "#C3C3C3", marginBottom: 24, borderRadius: 11, width: 300, height: 40 }}
        ...
        style={{ borderWidth: 1, borderColor: "#C3C3C3", marginBottom: 32, borderRadius: 11, width: 300, height: 40 }}
        onChangeText={inputNomorHandphone => { setNomorHandphone(inputNomorHandphone) }}
        />
        <View style={{ marginTop: 8, width: 300, height: 225, marginBottom: 10 }}>
          <Button
          ...
          />
           ...
           style={{marginTop: 100,flex : 1, width: 300, }}
           /> 
        </View>
      </View>
    </ScrollView>
